...
def main():
    ...
    caller=Path(tempfile.mkdtemp(prefix='pio-caller-',dir='/tmp'))
    ...
    try:
        ...
        caller2=Path(tempfile.mkdtemp(prefix='pio-caller-',dir='/tmp'));common2=common.copy();common2[1]=str(caller2)
