...
L3 is L1's shape on Codex 0.157.0 and `gpt-5.6-terra` (`--plan L3`, lead `L3`, sequence `M4-lead-codex`, cap 610,000, stop 488,000 since the owner's decision of 2026-09-26 for its second attempt, Q8; it was 565,000, stop 452,000 earlier that day, and 400,000, stop 320,000 before). Its claim is **a steer under the lead's grant, delivered to a running Codex turn**. M2 showed Codex acknowledge the owner's steer; L3 shows it under the lead's authority. Behavior stays `not_observed`: delivery is not obedience.
...
- **The limits (owner, 2026-09-26, "More headroom"; they were set on 2026-09-24).** Lead 150,000; child 60,000; a step at most 30,000, from the 22,000 to 24,500 per step M2 measured. Codex reports a step once its tool has finished, so a run can reach its ceiling plus two steps: the lead 210,000 and each child 120,000 (reviews of L3, rounds 1 and 2). The worst case is **450,000**, within the L3 sequence's 488,000 stop (cap 610,000; owner, 2026-09-26, Q8) after attempt 1's 36,126 (486,126), and, with Codex's 457,576 used, under the 908,000 Codex stop (cap 1,135,000): 907,576. Before attempt 1 it was checked against 452,000 (cap 565,000) and 872,000 (cap 1,090,000), with Codex's 421,450 used: 871,450. Under the limits of 2026-09-24 it was 405,000, past every one of them, and the runner refused a live L3. That figure holds only with Codex's unmetered features off: sub-agents (with them on, 0.157.0's default, it would be 720,000 for multi-agent V2 and 990,000 for V1), memories, goals, standalone web search and image generation; the runner refuses unless each is off, by the owner's configuration or per launch under a recorded owner decision (rounds 3 and 4). The reservation is made immediately before the lead's submit. A run that ended by itself is charged Codex's reported total, the sum over its threads; one whose turn was cut short (the runner's stop, or an interrupt the host sent) that total plus a step in flight on each of its threads; the full rules are in the [evidence README](evidence/README.md). The runner stops a run by that total, by a step past 30,000, and by a sub-agent appearing.
