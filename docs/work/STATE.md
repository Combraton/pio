...
| MiniMax via OpenCode | 300,000,000 | 240,000,000 | **53,828 charged**, 41,828 observed | 6 |
...
- **M3/M3b current counts:** **100 Cargo tests + 1 ignored probe**; Claude matrix **26 × 3 = 78**, fourteen through `serve-claude`; OpenCode matrix **23 × 3 = 69**, ten through `serve-opencode`, plus the OpenCode runner self-test; Codex matrix, public matrix and diagnostic matrix unchanged at 51, 72 and 54, which is the proof the shared work changed nothing else.
