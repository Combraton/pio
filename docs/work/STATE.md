...
| MiniMax via OpenCode | 300,000,000 | 240,000,000 | **160,395 charged**: M3b 86,863 (62,220 as recorded; corrected 2026-09-23) and L1 73,532 (2026-09-24); 77,549 observed | 10 |
...
- **L1 ran live** on 2026-09-24 at `703706d`, on branch `codex/m4-l1` ([PR #16](https://github.com/Combraton/pio/pull/16), draft): every row holds, **73,532 charged**, measured from the store's recorded steps. The receipt and what it does not show: [`m4/evidence/L1-live.json`](m4/evidence/README.md). Before merge: reviews 46's D1, E1 and E2, the release defect this run found, and a new rehearsal record.
