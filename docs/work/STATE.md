...
- **Next:** waiting on the owner for the model/version decision on [issue #5](https://github.com/Combraton/pio/issues/5); R2–R6 would fail the same way until it is resolved. No further live runs meanwhile.
