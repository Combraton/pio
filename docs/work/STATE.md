...
| MiniMax via OpenCode | 300,000,000 | 240,000,000 | 0 | 0 |
...
- **M3/M3b current counts:** **100 Cargo tests + 1 ignored probe**; Claude matrix **25 × 3 = 75**, thirteen through `serve-claude`; OpenCode matrix **18 × 3 = 54**, seven through `serve-opencode`, plus the OpenCode runner self-test; Codex matrix, public matrix and diagnostic matrix unchanged at 51, 72 and 54, which is the proof the shared work changed nothing else.
