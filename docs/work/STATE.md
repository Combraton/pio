...
- **M3 current counts:** **85 Cargo tests + 1 ignored probe**; Claude matrix **13 cases × 3 = 39**, two of them through the service; Codex matrix, public matrix and diagnostic matrix unchanged at 51, 72 and 54, which is the proof the shared-lifecycle extraction changed nothing else.
